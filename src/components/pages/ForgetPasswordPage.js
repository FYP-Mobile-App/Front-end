...
export default class ForgetPasswordPage extends React.Component {
  ...
  handleSubmit = (event) => {
    ...
    var number = "+" + this.state.countryCodeValue + this.state.phone;
    ...
    getOTP(number)
      ...
      .catch((error) => {
        if (error.response.status === 403) {
          swal("Warning", "This phone number is not registered", "warning");
        }
      });
  };
  ...
  render() {
    if (this.state.formSubmitted) {
      return <Redirect to={{ pathname: "/otp-forget-password" }} />;
    }
    return (
            ...
            <p>
              ...
              <div className="tel-box">
                <div className="select-box" onChange={this.countryFlagHandler}>
                  <img src={this.state.flagImg} id="img" className="flag-img" />
                  <select
                    id="country"
